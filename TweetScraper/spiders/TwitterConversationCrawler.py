...
class TwitterConversationScraper(CrawlSpider):
    ...
    def __init__(self, query=''):
        self.url = (
            ...
            f'&count=20'
            f'&include_ext_has_birdwatch_notes=false'
        )
        self.query = query
    ...
    def parse_result_page(self, response):
        """
        Get tweets, users, conversations and next request
        """
        # inspect_response(response, self)
    ...
    def parse_conversation_item(self, item):
